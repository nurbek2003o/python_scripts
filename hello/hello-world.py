...
#     return toliq_ism
# talaba1=toliq_ism_yasa('Hakim', 'Salimov')
# talaba2=toliq_ism_yasa('qochqar', 'qoziyev', 'boltayevich')
# print(talaba1.title())
# print(talaba2.title())
...
# avto2=avto_info('gm','lasetti', 'oq','mexanika',2020, 18000)
# avtolar=[avto1,avto2]
...
# Uyga vazifalar
# def toliq_ism_yasa(ism,familiya,tyil,tjoy,email='',tel=''):
#         toliq_ism={
#             'ism':ism,
#             'familiya':familiya,
#             'tyil':tyil,
...
#     email=input("email: ")
#     tel=input("telefon: ")
#     toliq_nom.append(toliq_ism_yasa(ism, familiya, tyil, tjoy, email, tel))
#     javob=input("Davom etasizmi? (ha/yoq): ")
#     if javob=='yoq':
#         break
# print(toliq_nom)
# for nom in toliq_nom:
#     print(
#         f"{nom['ism'].title()} {nom['familiya'].title()},"
#         f"{nom['yoshi']} yoshda, telefoni: {nom['tel']}"
#     )
